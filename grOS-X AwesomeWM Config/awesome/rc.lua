...
run_once("compton")
run_once("xset +fp ~/.fonts && xset fp rehash")
run_once("echo 'Welcome back rndtx!' | dzen2 -w 250 -h 25 -x 1660 -y 24 -fn 'Lemon' -p 2")
run_once("feh --bg-fill ~/Picture/img/cat.png")
...
-- (Use "feh /path/to/wall.jpg --bg-fill" in .xinitrc instead (* Before "exec awesome"))
-- Wallpaper
...
mygraphics = {
    ...
    { "Gimp",           "gimp" },
    { menu_sep,         "" },
    { "Feh",            "feh "..home.."/pictures/" },
    { "Sxiv",           "sxiv -tsr "..home.."/pictures" }
}
...
mysystem = {
    ...
    { "Lock Screen",    "sh "..home.."/.lockscreen" },
    ...
    { "Shutdown",       "poweroff" },
    { menu_sep,         "" },
    { "Performance",    "sh "..home.."/scripts/compton game" },
    { "Quality",        "sh "..home.."/scripts/compton" }
}
...
vicious.register( syswidget, vicious.widgets.os, "<span color=\""..color_data.."\">$2</span>" )

-- Uptime
uptimewidget = wibox.widget.textbox()
vicious.register( uptimewidget, vicious.widgets.uptime, "<span color=\""..color_text.."\">Up</span> <span color=\""..color_data.."\">$2.$3</span>" )

-- Cpu
cpuwidget = wibox.widget.textbox()
vicious.register( cpuwidget, vicious.widgets.cpu, "<span color=\""..color_text.."\">Cpu</span> <span color=\""..color_data.."\">$1%</span>", 3 )

-- Ram
memwidget = wibox.widget.textbox()
vicious.register( memwidget, vicious.widgets.mem, "<span color=\""..color_text.."\">Mem</span> <span color=\""..color_data.."\">$2MiB</span>", 5 )

-- Clock
mytextclock = awful.widget.textclock("<span color=\""..color_icon.."\">⮖</span> <span color=\""..color_data.."\">%a, %d %b %H:%M</span> " )
...
vicious.register( mpdwidget, vicious.widgets.mpd, function(widget, args)
	if args["{state}"] == "Stop" then
		...
		return '<span color="'..color_icon..'">⮕</span> <span color="'..color_data..'">'..args["{Artist}"]..' - '..args["{Title}"]..'</span>'
	end
end, 1)
...
vicious.register(volumewidget, vicious.widgets.volume, function(volumewidget, args)
    local volbar = ""
    local volico = "<span color='"..color_icon.."'>"
    local vol = math.floor(args[1] / 10)

    volbar = "<span color='"..color_data.."'>"..string.rep("⮶",vol).."</span>"..
             "<span color='"..color_dark.."'>"..string.rep("⮶",10-vol).."</span>"
...
vicious.register(batwidget, vicious.widgets.bat, function (batwidget, args)
    local batbar = ""
    local batico = "<span color='"..color_icon.."'>"
    ...
    batbar = "<span color='"..c_col1.."'>"..string.rep("⮶",bat).."</span>"..
             "<span color='"..c_col2.."'>"..string.rep("⮶",10-bat).."</span>"
...
globalkeys = awful.util.table.join(
    -- Capture Screenshot
	--awful.key({ }, "Print", function () awful.util.spawn("scrot -e 'mv $f /home/dwv/div/screenshots/ 2>/dev/null'") end),
	awful.key({ }, "Print", function () awful.util.spawn("sh "..home.."/scripts/takeshot 1.5") end),
	...
	awful.key({ "Control", altkey }, "l",         function () awful.util.spawn( home.."/.lockscreen", false) end),
	...
	function ()
		...
		ypromptbox[mouse.screen].widget,
		awful.util.eval, nil,
