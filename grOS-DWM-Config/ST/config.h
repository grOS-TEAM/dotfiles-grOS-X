...
static int borderpx = 15;						// Border around shell
static const unsigned int rows = 28;			// Initial Number of rows
static const unsigned int collumns = 81;		// Initial Number of Collumns
static char shell[] = "/usr/bin/zsh";

// Font Setting
static char font[] = "-*-uushi-*-*-*-*-11-*-*-*-*-*-*-*";
float cwscale = 0.53;
float chscale = 1.1;
...
//
// Bell volume. Value between -100 and 100, 0 to Disable
...
static unsigned int defaultfg = 9;
...
// Some other Settings I don't understand
